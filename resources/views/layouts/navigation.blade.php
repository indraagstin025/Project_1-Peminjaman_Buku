<div class="fixed-top">
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary px-3">
        <div class="container-fluid">
            <a class="navbar-brand fs-4 fw-bold" href="{{ route('home') }}">BukuPinjam</a>
            ...
            <div class="collapse navbar-collapse" id="navbarItems">
                <div class="navbar-nav ms-auto">
                    @auth
                    <a class="nav-link {{ request()->routeIs('wishlists.index') ? 'active' : '' }}" href="{{ route('wishlists.index') }}">Wishlist</a>
                    <a class="nav-link {{ request()->routeIs('my-books.*') ? 'active' : '' }}" href="{{ route('my-books.index') }}">Buku-ku</a>
                    <a class="nav-link {{ request()->routeIs('chat.index') ? 'active' : '' }}" href="{{ route('chat.index') }}">Chat</a>
