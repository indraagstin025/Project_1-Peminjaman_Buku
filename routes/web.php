...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/wishlists/{book}', [WishlistController::class, 'store'])->name('wishlists.store');
    Route::delete('/wishlists/{book}', [WishlistController::class, 'destroy'])->name('wishlists.destroy');
